...
class _AddMaterialsState extends State<AddMaterials> {
  ...
  Scaffold getWebUi() {
    ...
    return Scaffold(
        floatingActionButton: _saving ? null : FloatingActionButton(onPressed: () => {save()}, child: const Icon(Icons.save_rounded)),
                                          ...
                                          itemBuilder: (BuildContext context, int index) {
                                            ...
                                            return InkWell(
                                              ...
                                              child: Builder(builder: (BuildContext context) {
                                                ...
                                                return Container(
                                                    color: highlight ? Theme.of(context).focusColor : null, padding: const EdgeInsets.all(16.0), child: Text((option)));
                                              }),
                                            );
                                          },
                                        ),
