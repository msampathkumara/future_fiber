...
class ServerApi {
  ...
  static Future<Response> tickets_completed_delete(Map<String, dynamic> data, {FormData? formData, Null Function(int sent, int total)? onSendProgress, bool reFreshToken = false}) {
    String url = "tickets/completed/delete";
  ...
  static Future<Response> tickets_delete(Map<String, dynamic> data, {FormData? formData, Null Function(int sent, int total)? onSendProgress, bool reFreshToken = false}) {
    String url = "tickets/delete";
  ...
  static Future<Response> materialManagement_cpr_getCprsByTicketId(Map<String, dynamic> data,
      {FormData? formData, Null Function(int sent, int total)? onSendProgress, bool reFreshToken = false}) {
    String url = "materialManagement/cpr/getCprsByTicketId";
  ...
  static Future<Response> materialManagement_order(Map<String, dynamic> data, {FormData? formData, Null Function(int sent, int total)? onSendProgress, bool reFreshToken = false}) {
    String url = "materialManagement/order";

    return Api.post(url, data, formData: formData, onSendProgress: onSendProgress, reFreshToken: reFreshToken);
  }

  static Future<Response> materialManagement_orderKitByTicketId(Map<String, dynamic> data,
      {FormData? formData, Null Function(int sent, int total)? onSendProgress, bool reFreshToken = false}) {
    String url = "materialManagement/orderKitByTicketId";
