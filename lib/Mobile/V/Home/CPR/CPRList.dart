...
import '../../../../C/Api.dart';
import '../../../../M/Enums.dart';
import '../../Widgets/RefreshIndicatorMessageBox.dart';
...
class _CPRListState extends State<CPRList> {
  ...
  final __statusList = ["All", "Ready", "Pending", "Sent"];
  final __clients = Production.values.where((element) => element != Production.None).map((e) => e.getValue()).toList();
  final __suppliers = ["All", "Cutting", "SA", "Printing"];
  final __shortageTypes = ["All", "Short", "Damage", "Unreceived"];
  final __cprTypes = ["All", "Pocket", "Rope Luff", "Purchase Cover", "Overhead Tape", "Tape Cover", "Take Down", "Soft Hanks", "Windows", "Stow pouch", "VPC**", "Other"];
          ...
          child: MeasuredSize(
            ...
            child: Wrap(
              children: [
                ...
                ListTile(
                    title: const Text("Shortage Type", style: TextStyle(color: Colors.white)),
                    subtitle: Wrap(spacing: 5, children: [
