...
/// A [CustomWebViewPlatformController] that uses a method channel to control the webview.
class MethodChannelCustomWebViewPlatform implements CustomWebViewPlatformController {
  ...
  final CustomWebViewPlatformCallbacksHandler _platformCallbacksHandler;
  ...
  Future<bool?> _onMethodCall(MethodCall call) async {
    switch (call.method) {
      ...
      case 'onProgress':
        ...
        _platformCallbacksHandler.onShowFileChooser(call.arguments['filePathCallback']);
        return null;
      case 'onPageStarted':
  ...
  /// Method channel implementation for [CustomWebViewPlatform.clearCookies].
  ...
  /// [AndroidCustomWebViewBuilder] and [CupertinoCustomWebViewBuilder].
