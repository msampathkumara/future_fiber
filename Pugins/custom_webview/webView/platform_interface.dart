...
/// Interface for callbacks made by [CustomWebViewPlatformController].
///
/// The webview plugin implements this class, and passes an instance to the [CustomWebViewPlatformController].
/// [CustomWebViewPlatformController] is notifying this handler on events that happened on the platform's webview.
abstract class CustomWebViewPlatformCallbacksHandler {
  /// Invoked by [CustomWebViewPlatformController] when a JavaScript channel message is received.
  void onJavaScriptChannelMessage(String channel, String message);

  /// Invoked by [CustomWebViewPlatformController] when a navigation request is pending.
  ///
  /// If true is returned the navigation is allowed, otherwise it is blocked.
  FutureOr<bool> onNavigationRequest({required String url, required bool isForMainFrame});

  /// Invoked by [CustomWebViewPlatformController] when a page has started loading.
  void onPageStarted(String url);

  /// Invoked by [CustomWebViewPlatformController] when a page has finished loading.
  void onPageFinished(String url);

  /// Invoked by [CustomWebViewPlatformController] when a page is loading.
  ...
  void onShowFileChooser(argument);
}
...
/// Error returned in `CustomWebView.onWebResourceError` when a web resource loading error has occurred.
class WebResourceError {
  ...
  /// [CustomWebViewClient](https://developer.android.com/reference/android/webkit/CustomWebViewClient#summary) and
  ...
  /// the last values provided to [CustomWebViewPlatformController.loadUrl].
  final String? failingUrl;
}

/// Interface for talking to the webview's platform implementation.
///
/// An instance implementing this interface is passed to the `onCustomWebViewPlatformCreated` callback that is
/// passed to [CustomWebViewPlatformBuilder#onCustomWebViewPlatformCreated].
///
...
/// by newly added [CustomWebViewPlatformController] methods.
abstract class CustomWebViewPlatformController {
  /// Creates a new CustomWebViewPlatform.
  ///
  /// Callbacks made by the CustomWebView will be delegated to `handler`.
  ///
  /// The `handler` parameter must not be null.
  CustomWebViewPlatformController(CustomWebViewPlatformCallbacksHandler handler);
  ...
  Future<void> loadUrl(
    ...
    throw UnimplementedError("CustomWebView loadUrl is not implemented on the current platform");
  }
  ...
  Future<void> updateSettings(WebSettings setting) {
    throw UnimplementedError("CustomWebView updateSettings is not implemented on the current platform");
  }
  ...
  Future<String?> currentUrl() {
    throw UnimplementedError("CustomWebView currentUrl is not implemented on the current platform");
  }

  /// Checks whether there's a back history item.
  Future<bool> canGoBack() {
    throw UnimplementedError("CustomWebView canGoBack is not implemented on the current platform");
  }

  /// Checks whether there's a forward history item.
  Future<bool> canGoForward() {
    throw UnimplementedError("CustomWebView canGoForward is not implemented on the current platform");
  }
  ...
  Future<void> goBack() {
    throw UnimplementedError("CustomWebView goBack is not implemented on the current platform");
  }
  ...
  Future<void> goForward() {
    throw UnimplementedError("CustomWebView goForward is not implemented on the current platform");
  }

  /// Reloads the current URL.
  Future<void> reload() {
    throw UnimplementedError("CustomWebView reload is not implemented on the current platform");
  }
  ...
  Future<void> clearCache() {
    throw UnimplementedError("CustomWebView clearCache is not implemented on the current platform");
  }
  ...
  Future<String> evaluateJavascript(String javascriptString) {
    throw UnimplementedError("CustomWebView evaluateJavascript is not implemented on the current platform");
  }
  ...
  Future<void> addJavascriptChannels(Set<String> javascriptChannelNames) {
    throw UnimplementedError("CustomWebView addJavascriptChannels is not implemented on the current platform");
  }
  ...
  Future<void> removeJavascriptChannels(Set<String> javascriptChannelNames) {
    throw UnimplementedError("CustomWebView removeJavascriptChannels is not implemented on the current platform");
  }

  /// Returns the title of the currently loaded page.
  Future<String?> getTitle() {
    throw UnimplementedError("CustomWebView getTitle is not implemented on the current platform");
  }

  /// Set the scrolled position of this view.
  ///
  /// The parameters `x` and `y` specify the position to scroll to in CustomWebView pixels.
  Future<void> scrollTo(int x, int y) {
    throw UnimplementedError("CustomWebView scrollTo is not implemented on the current platform");
  }

  /// Move the scrolled position of this view.
  ///
  /// The parameters `x` and `y` specify the amount of CustomWebView pixels to scroll by.
  Future<void> scrollBy(int x, int y) {
    throw UnimplementedError("CustomWebView scrollBy is not implemented on the current platform");
  }
  ...
  Future<int> getScrollX() {
    throw UnimplementedError("CustomWebView getScrollX is not implemented on the current platform");
  }
  ...
  Future<int> getScrollY() {
    throw UnimplementedError("CustomWebView getScrollY is not implemented on the current platform");
  }
}

/// A single setting for configuring a CustomWebViewPlatform which may be absent.
class WebSetting<T> {
...
/// Settings for configuring a CustomWebViewPlatform.
///
/// Initial settings are passed as part of [CreationParams], settings updates are sent with
/// [CustomWebViewPlatform#updateSettings].
///
...
class WebSettings {
  ...
  /// Whether the [CustomWebView] has a [NavigationDelegate] set.
  final bool? hasNavigationDelegate;

  /// Whether the [CustomWebView] should track page loading progress.
  /// See also: [CustomWebViewPlatformCallbacksHandler.onProgress] to get the progress.
  final bool? hasProgressTracking;

  /// Whether to enable the platform's webview content debugging tools.
  ///
  /// See also: [CustomWebView.debuggingEnabled].
  ...
  ///
  /// See also [CustomWebView.userAgent].
  final WebSetting<String?> userAgent;

  /// Whether to allow swipe based navigation in iOS.
  ///
  /// See also: [CustomWebView.gestureNavigationEnabled]
...
/// Configuration to use when creating a new [CustomWebViewPlatformController].
///
/// The `autoMediaPlaybackPolicy` parameter must not be null.
class CreationParams {
  /// Constructs an instance to use when creating a new
  /// [CustomWebViewPlatformController].
  ///
  /// The `autoMediaPlaybackPolicy` parameter must not be null.
  CreationParams({
    this.initialUrl,
  ...
  ///
  /// This can later be updated with [CustomWebViewPlatformController.updateSettings].
...
/// Signature for callbacks reporting that a [CustomWebViewPlatformController] was created.
///
/// See also the `onCustomWebViewPlatformCreated` argument for [CustomWebViewPlatform.build].
typedef CustomWebViewPlatformCreatedCallback = void Function(CustomWebViewPlatformController? customWebViewPlatformController);

/// Interface for a platform implementation of a CustomWebView.
///
/// [CustomWebView.platform] controls the builder that is used by [CustomWebView].
/// [AndroidCustomWebViewPlatform] and [CupertinoCustomWebViewPlatform] are the default implementations
/// for Android and iOS respectively.
abstract class CustomWebViewPlatform {
  /// Builds a new CustomWebView.
  ///
  /// Returns a Widget tree that embeds the created webview.
  ///
  /// `creationParams` are the initial parameters used to setup the webview.
  ///
  /// `customWebViewPlatformHandler` will be used for handling callbacks that are made by the created
  /// [CustomWebViewPlatformController].
  ///
  /// `onCustomWebViewPlatformCreated` will be invoked after the platform specific [CustomWebViewPlatformController]
  /// implementation is created with the [CustomWebViewPlatformController] instance as a parameter.
  ///
  ...
  ///
  /// `customWebViewPlatformHandler` must not be null.
  Widget build({
  ...
  Future<bool> clearCookies() {
    throw UnimplementedError("CustomWebView clearCookies is not implemented on the current platform");
  }
}
