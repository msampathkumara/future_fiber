...
/** Builder used to create {@link WebView} objects. */
public class WebViewBuilder {

  /** Factory used to create a new {@link WebView} instance. */
  static class WebViewFactory {
     ...
     * @return A new instance of the {@link WebView} object.
     */
   ...
   *
   * @param flag {@code true} is {@link WebView} should use the DOM storage API.
  ...
  /**
   * Build the {@link WebView} using the current settings.
   *
   * @return The {@link WebView} using the current settings.
   */
