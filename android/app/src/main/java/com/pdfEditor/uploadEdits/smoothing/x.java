package com.pdfEditor.uploadEdits.smoothing;//package com.pdfEditor.uploadEdits.smoothing;
//
...
//    public static void GetCurveControlPoints(Point[] knots,   Point[] firstControlPoints,   Point[] secondControlPoints) throws Exception {
//        if (knots == null)
//            throw new Exception("knots missing");
